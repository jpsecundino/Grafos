...
/*      Calcula similaridade entre os vértices de dois grafos.
    Parâmetros:
        - graph *g1 : grafo a ser comparado
        - graph *g2 : grafo a ser comparado
    Retorno:
        - valor da similaridade calculada
*/
double graph_vertex_similarity(graph *g1, graph *g2);

/*      Calcula similaridade entre os arestas de dois grafos
    Parâmetros:
        - graph *g1 : grafo a ser comparado
        - graph *g2 : grafo a ser comparado
    Retorno:
